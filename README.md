...
Отчет помогает спланировать задачи спринта равномерно по сотрудникам, так как на отчете это прозрачно видно. Наработку можно использовать для реализации других нужных отчетов, которые не возможно сформировать в Jira стандартными методами.
